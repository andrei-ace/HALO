...
class SkillRunnerConfig:
    ...
    plan_approach_timeout_ms: int = 30_000
    move_pregrasp_timeout_ms: int = 30_000
    visual_align_timeout_ms: int = 30_000
    execute_approach_timeout_ms: int = 30_000

    # Timed phases (no sensor exit condition in v0)
    close_gripper_duration_ms: int = 30_000
    verify_duration_ms: int = 30_000
    lift_duration_ms: int = 30_000

    # Recovery
    recover_wait_ms: int = 500
    max_reacquire_attempts: int = 3
    no_target_tolerance_ms: int = 30_000  # target absent this long -> recovery
    ...
    # PLACE thresholds
    select_place_timeout_ms: int = 30_000
    place_align_threshold_m: float = 0.10
    place_distance_threshold_m: float = 0.02
    transit_preplace_timeout_ms: int = 30_000
    descend_place_timeout_ms: int = 30_000
    open_gripper_duration_ms: int = 30_000
    retreat_duration_ms: int = 30_000
    returning_timeout_ms: int = 30_000  # max wait for return-to-home trajectory
