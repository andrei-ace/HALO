"""Live cognitive backend — Gemini Live API (bidirectional audio + text).
...
from halo.cognitive.config import BackendReadiness, BackendType, LiveConfig
...
class LiveCognitiveBackend:
    ...
    async def warm_up(
        ...
        try:
            ...
            logger.exception("Live session warm_up failed")
            return False
